...
const get_arxiv_url = ({ searchQuery, sortBy, sortOrder, start, maxResults }) =>
	`https://api.codetabs.com/v1/proxy/?quest=http://export.arxiv.org/api/query?search_query=${searchQuery}&start=${start}&max_results=${maxResults}${sortBy ? `&sortBy=${sortBy}` : ''
